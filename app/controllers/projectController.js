//  spaceApp.filter('filterByStatus', function(){
//     return function(projects,names){
//         return projects.filter(function(project) {
//           return project.stat.text =='All';
//         });
//     };
// });
spaceApp.controller("projectController", function($scope) {
    ...
    $scope.billtypes = ["All", "Fixed Cost", "Time & Material","Internal"];
